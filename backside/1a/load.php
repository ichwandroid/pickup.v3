...
?>
    <div class='d-flex text-body-secondary pt-3'>
        ...
        <div class='pb-3 mb-0 small lh-sm border-bottom w-100'>
            ...
            <div class='d-flex justify-content-between'><span class='d-block'> <?= $panggilan ?> | <?= $kelas ?></span><a style='text-decoration: none; color:gray; font-size:12px; padding-top:5px'><?= $waktu ?></a></div>
        </div>
    </div>
