...
<body class="d-flex flex-column h-100">
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      <div class="container-fluid" id='regBox'>
            ...
            <li class="nav-item">
              <form action="" id='regForm' method="post">
                <div class="input-group mb-3" style="padding-top: 10px;">
                  ...
                  <input type="text" class="form-control" id="nis" name="nis" placeholder="Scan QR Code" autofocus>
                  <input type="text" class="form-control" id="status" name="status" placeholder="Status" value="Ditunggu Orang Tua" hidden>
  ...
  <main class="flex-shrink-0">
    <div class="container-fluid" style="padding-top: 60px;">
      <h1 class="mt-5">Pickup Student V.3</h1>
      <p class="lead">Anak Saleh Elementary School.</p>
